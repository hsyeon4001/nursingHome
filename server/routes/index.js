...
router.get(
	routesVariables.gallery.path,
	indexController.readPost,
	indexController.renderPage
);
router.get(
	routesVariables.notice.path,
	indexController.readPost,
	indexController.renderPage
);
...
router.get(
	routesVariables.galleryPostView.path,
	indexController.readPostView,
	indexController.renderPage
);
router.get(
	routesVariables.noticePostView.path,
	indexController.readPostView,
	indexController.renderPage
);
router.get(
	routesVariables.post.path,
	accessController.chkStaff,
	indexController.renderPage
);
router.get(
	routesVariables.admin.path,
	accessController.chkAdmin,
	indexController.renderPage
);

router.post(
	routesVariables.search.path,
	indexController.searchPosts,
	indexController.renderPage
);
